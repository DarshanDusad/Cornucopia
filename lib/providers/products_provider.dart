...
Products(this.authToken,this._items,this.uid);
  ...
  Future<void> fetchAndSetProducts([bool filter = false]) async {
    ...
    var url = 'https://cornucopia-17f73.firebaseio.com/Products.json?auth=$authToken$filterString';
    ...
    url = "https://cornucopia-17f73.firebaseio.com/UserFavourites/$uid.json?auth=$authToken";
  ...
  Future<void> addProduct(Product product) async {
    final url = "https://cornucopia-17f73.firebaseio.com/Products.json?auth=$authToken";
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (index >= 0) {
      final url = "https://cornucopia-17f73.firebaseio.com/Products/$id.json?auth=$authToken";
